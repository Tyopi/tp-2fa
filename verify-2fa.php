...
die("<p> Session invalide. <a href='setup-2fa.php'>Recommencer la❌configuration</a>.</p>");
}
$userId = (int)$_SESSION['user']['id'];
$secret = $_SESSION['tfa_secret_temp'];
$userCode = preg_replace('/\D/', '', $_POST['code'] ?? '');
if (strlen($userCode) !== 6) {
die("<p> Code invalide (6 chiffres attendus).</p><p><a❌href='setup-2fa.php'>Retour</a></p>");
}
